...
-- Tiempo de generación: 20-06-2024 a las 23:12:05
...
--
-- Base de datos: `kingtech_matriz__`
--
...
INSERT INTO `clientes` (`id`, `codigo_sede`, `dni`, `fecha_implementacion`, `estado`, `instalacion`, `motivo_bloqueo`, `estado_instalacion`, `solicitud_bloqueo`) VALUES
(1, 0, '12345678', '2024-06-14', 'Activo', 'Completa', 'Ninguno', 'Completada', 'No solicitado'),
(2, 0, '87654321', '2024-06-15', 'Activo', 'Completa', 'Ninguno', 'Completada', 'No solicitado'),
(3, 0, '56789012', '2024-06-16', 'Activo', 'Completa', 'Ninguno', 'Completada', 'No solicitado'),
(4, 0, '34567890', '2024-06-17', 'Activo', 'Completa', 'Ninguno', 'Completada', 'No solicitado'),
(5, 0, '90123456', '2024-06-18', 'Activo', 'Completa', 'Ninguno', 'Completada', 'No solicitado'),
(6, 0, '23456789', '2024-06-19', 'Activo', 'Completa', 'Ninguno', 'Completada', 'No solicitado'),
(7, 0, '67890123', '2024-06-20', 'Activo', 'Completa', 'Ninguno', 'Completada', 'No solicitado'),
(8, 0, '45678901', '2024-06-21', 'Activo', 'Completa', 'Ninguno', 'Completada', 'No solicitado'),
(9, 0, '78901234', '2024-06-22', 'Activo', 'Completa', 'Ninguno', 'Completada', 'No solicitado'),
(10, 0, '01234567', '2024-06-23', 'Activo', 'Completa', 'Ninguno', 'Completada', 'No solicitado');
...
CREATE TABLE IF NOT EXISTS `detalle_sede` (
  `id` int NOT NULL AUTO_INCREMENT,
  `codigo_sede` int DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `interesados` (
  ...
  `tipo_negocio` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
...
INSERT INTO `plataforma` (`id`, `plataforma`, `codigo_plaforma`, `created_at`, `updated_at`) VALUES
(1, 'Plataforma 1', 0, '2024-06-19 03:13:30', '2024-06-19 03:13:30'),
(2, 'Plataforma 2', 0, '2024-06-19 03:13:30', '2024-06-19 03:13:30'),
(3, 'Plataforma 3', 0, '2024-06-19 03:13:30', '2024-06-19 03:13:30'),
(4, 'Plataforma 4', 0, '2024-06-19 03:13:30', '2024-06-19 03:13:30'),
(5, 'Plataforma 5', 0, '2024-06-19 03:13:30', '2024-06-19 03:13:30'),
(6, 'Plataforma 6', 0, '2024-06-19 03:13:30', '2024-06-19 03:13:30'),
(7, 'Plataforma 7', 0, '2024-06-19 03:13:30', '2024-06-19 03:13:30'),
(8, 'Plataforma 8', 0, '2024-06-19 03:13:30', '2024-06-19 03:13:30'),
(9, 'Plataforma 9', 0, '2024-06-19 03:13:30', '2024-06-19 03:13:30'),
(10, 'Plataforma 10', 0, '2024-06-19 03:13:30', '2024-06-19 03:13:30'),
(11, NULL, 0, '2024-06-20 22:28:33', '2024-06-20 22:28:33'),
(12, NULL, 0, '2024-06-20 22:41:13', '2024-06-20 22:41:13'),
(13, NULL, 0, '2024-06-20 22:41:18', '2024-06-20 22:41:18');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `plataformas_sede`
--

DROP TABLE IF EXISTS `plataformas_sede`;
CREATE TABLE IF NOT EXISTS `plataformas_sede` (
  `id` int NOT NULL,
...
INSERT INTO `transacciones` (`id`, `fecha`, `codigo_sede`, `codigo_transaccion`, `ticket`, `venta`, `utilidad`, `created_at`, `updated_at`) VALUES
(1, '2024-12-03', 477, 0, 60838, 611.22, 115.51, '0000-00-00 00:00:00.000000', '0000-00-00 00:00:00.000000'),
(2, '2024-04-27', 914, 0, 60542, 285.32, 305.17, '0000-00-00 00:00:00.000000', '0000-00-00 00:00:00.000000'),
(3, '2024-03-12', 148, 0, 15203, 316.51, 63.23, '0000-00-00 00:00:00.000000', '0000-00-00 00:00:00.000000'),
(4, '2024-09-06', 35, 0, 12472, 519.72, 112.21, '0000-00-00 00:00:00.000000', '0000-00-00 00:00:00.000000'),
(5, '2024-07-24', 142, 0, 1879, 669.31, 145.11, '0000-00-00 00:00:00.000000', '0000-00-00 00:00:00.000000'),
(6, '2024-06-10', 346, 0, 39638, 946.36, 271.33, '0000-00-00 00:00:00.000000', '0000-00-00 00:00:00.000000'),
(7, '2024-11-15', 744, 0, 9258, 233.77, 445.55, '0000-00-00 00:00:00.000000', '0000-00-00 00:00:00.000000'),
(8, '2024-10-02', 98, 0, 22685, 840.47, 260.90, '0000-00-00 00:00:00.000000', '0000-00-00 00:00:00.000000'),
(9, '2024-02-01', 873, 0, 10055, 884.67, 60.87, '0000-00-00 00:00:00.000000', '0000-00-00 00:00:00.000000'),
(10, '2024-12-14', 409, 0, 17673, 659.18, 382.86, '0000-00-00 00:00:00.000000', '0000-00-00 00:00:00.000000'),
(11, '2024-11-06', 959, 0, 23731, 312.26, 424.70, '0000-00-00 00:00:00.000000', '0000-00-00 00:00:00.000000'),
(12, '2024-04-23', 3, 0, 8373, 410.00, 399.40, '0000-00-00 00:00:00.000000', '0000-00-00 00:00:00.000000'),
(13, '2024-10-05', 424, 0, 82711, 863.95, 419.22, '0000-00-00 00:00:00.000000', '0000-00-00 00:00:00.000000'),
(14, '2024-08-07', 487, 0, 63162, 698.42, 298.63, '0000-00-00 00:00:00.000000', '0000-00-00 00:00:00.000000'),
(15, '2024-11-21', 664, 0, 64435, 231.22, 111.54, '0000-00-00 00:00:00.000000', '0000-00-00 00:00:00.000000'),
(16, '2024-06-02', 440, 0, 93157, 339.81, 452.18, '0000-00-00 00:00:00.000000', '0000-00-00 00:00:00.000000'),
(17, '2024-07-02', 799, 0, 48722, 39.41, 367.72, '0000-00-00 00:00:00.000000', '0000-00-00 00:00:00.000000'),
(18, '2024-07-23', 589, 0, 26492, 559.56, 1.53, '0000-00-00 00:00:00.000000', '0000-00-00 00:00:00.000000'),
(19, '2024-05-02', 674, 0, 35891, 773.35, 395.02, '0000-00-00 00:00:00.000000', '0000-00-00 00:00:00.000000'),
(20, '2024-08-17', 781, 0, 1231, 719.90, 281.30, '0000-00-00 00:00:00.000000', '0000-00-00 00:00:00.000000');
...
INSERT INTO `utilidad` (`id`, `codigo_sede`, `sistema`, `juego`, `periodo`, `administrador`, `sede`, `razon_social`, `ruc`, `utilidad_bruta_100`, `impuesto_12`, `utilidad_impuesto`, `porcentaje_base`, `utilidad_neta`, `total_a_depositar`, `pago`, `porcentaje_com_adm`, `com_adm_s`, `porcentaje_participacion`, `documento_atribucion`, `created_at`, `updated_at`) VALUES
(1, 1, 'sistema1', 'juego1', '2024-01', 'admin1', 'sede1', 'Razón Social 1', '12345678901', 1000.00, 120.00, 880.00, 10.00, 792.00, 1000.00, 0.00, 5.00, 0.00, 50.00, 'doc_atribucion1', 0, 0),
(2, 2, 'sistema2', 'juego2', '2024-02', 'admin2', 'sede2', 'Razón Social 2', '12345678902', 1500.00, 180.00, 1320.00, 12.00, 1188.00, 1500.00, 0.00, 6.00, 0.00, 60.00, 'doc_atribucion2', 0, 0),
(3, 3, 'sistema3', 'juego3', '2024-03', 'admin3', 'sede3', 'Razón Social 3', '12345678903', 2000.00, 240.00, 1760.00, 15.00, 1584.00, 2000.00, 0.00, 7.00, 0.00, 70.00, 'doc_atribucion3', 0, 0),
(4, 4, 'sistema4', 'juego4', '2024-04', 'admin4', 'sede4', 'Razón Social 4', '12345678904', 2500.00, 300.00, 2200.00, 18.00, 1980.00, 2500.00, 0.00, 8.00, 0.00, 80.00, 'doc_atribucion4', 0, 0),
(5, 5, 'sistema5', 'juego5', '2024-05', 'admin5', 'sede5', 'Razón Social 5', '12345678905', 3000.00, 360.00, 2640.00, 20.00, 2376.00, 3000.00, 0.00, 9.00, 0.00, 90.00, 'doc_atribucion5', 0, 0),
(6, 6, 'sistema6', 'juego6', '2024-06', 'admin6', 'sede6', 'Razón Social 6', '12345678906', 3500.00, 420.00, 3080.00, 22.00, 2772.00, 3500.00, 0.00, 10.00, 0.00, 100.00, 'doc_atribucion6', 0, 0),
(7, 7, 'sistema7', 'juego7', '2024-07', 'admin7', 'sede7', 'Razón Social 7', '12345678907', 4000.00, 480.00, 3520.00, 25.00, 3168.00, 4000.00, 0.00, 11.00, 0.00, 110.00, 'doc_atribucion7', 0, 0),
(8, 8, 'sistema8', 'juego8', '2024-08', 'admin8', 'sede8', 'Razón Social 8', '12345678908', 4500.00, 540.00, 3960.00, 28.00, 3564.00, 4500.00, 0.00, 12.00, 0.00, 120.00, 'doc_atribucion8', 0, 0),
(9, 9, 'sistema9', 'juego9', '2024-09', 'admin9', 'sede9', 'Razón Social 9', '12345678909', 5000.00, 600.00, 4400.00, 30.00, 3960.00, 5000.00, 0.00, 13.00, 0.00, 130.00, 'doc_atribucion9', 0, 0),
(10, 10, 'sistema10', 'juego10', '2024-10', 'admin10', 'sede10', 'Razón Social 10', '12345678910', 5500.00, 660.00, 4840.00, 32.00, 4356.00, 5500.00, 0.00, 14.00, 0.00, 140.00, 'doc_atribucion10', 0, 0),
(11, 11, 'sistema11', 'juego11', '2024-11', 'admin11', 'sede11', 'Razón Social 11', '12345678911', 6000.00, 720.00, 5280.00, 35.00, 4752.00, 6000.00, 0.00, 15.00, 0.00, 150.00, 'doc_atribucion11', 0, 0),
(12, 12, 'sistema12', 'juego12', '2024-12', 'admin12', 'sede12', 'Razón Social 12', '12345678912', 6500.00, 780.00, 5720.00, 38.00, 5148.00, 6500.00, 0.00, 16.00, 0.00, 160.00, 'doc_atribucion12', 0, 0),
(13, 13, 'sistema13', 'juego13', '2025-01', 'admin13', 'sede13', 'Razón Social 13', '12345678913', 7000.00, 840.00, 6160.00, 40.00, 5544.00, 7000.00, 0.00, 17.00, 0.00, 170.00, 'doc_atribucion13', 0, 0),
(14, 14, 'sistema14', 'juego14', '2025-02', 'admin14', 'sede14', 'Razón Social 14', '12345678914', 7500.00, 900.00, 6600.00, 42.00, 5940.00, 7500.00, 0.00, 18.00, 0.00, 180.00, 'doc_atribucion14', 0, 0),
(15, 15, 'sistema15', 'juego15', '2025-03', 'admin15', 'sede15', 'Razón Social 15', '12345678915', 8000.00, 960.00, 7040.00, 45.00, 6336.00, 8000.00, 0.00, 19.00, 0.00, 190.00, 'doc_atribucion15', 0, 0),
(16, 16, 'sistema16', 'juego16', '2025-04', 'admin16', 'sede16', 'Razón Social 16', '12345678916', 8500.00, 1020.00, 7480.00, 48.00, 6732.00, 8500.00, 0.00, 20.00, 0.00, 200.00, 'doc_atribucion16', 0, 0),
(17, 17, 'sistema17', 'juego17', '2025-05', 'admin17', 'sede17', 'Razón Social 17', '12345678917', 9000.00, 1080.00, 7920.00, 50.00, 7128.00, 9000.00, 0.00, 21.00, 0.00, 210.00, 'doc_atribucion17', 0, 0),
(18, 18, 'sistema18', 'juego18', '2025-06', 'admin18', 'sede18', 'Razón Social 18', '12345678918', 9500.00, 1140.00, 8360.00, 52.00, 7524.00, 9500.00, 0.00, 22.00, 0.00, 220.00, 'doc_atribucion18', 0, 0),
(19, 19, 'sistema19', 'juego19', '2025-07', 'admin19', 'sede19', 'Razón Social 19', '12345678919', 10000.00, 1200.00, 8800.00, 55.00, 7920.00, 10000.00, 0.00, 23.00, 0.00, 230.00, 'doc_atribucion19', 0, 0),
(20, 20, 'sistema20', 'juego20', '2025-08', 'admin20', 'sede20', 'Razón Social 20', '12345678920', 10500.00, 1260.00, 9240.00, 58.00, 8316.00, 10500.00, 0.00, 24.00, 0.00, 240.00, 'doc_atribucion20', 0, 0);
COMMIT;
